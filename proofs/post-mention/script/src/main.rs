...
const ELF: Elf = include_elf!("post-mention-program");

#[derive(Parser)]
#[command(name = "post-mention", about = "Prove that a DID mentioned another DID in a post")]
struct Args {
...
fn main() -> Result<()> {
    ...
    match args.mode.as_str() {
        "execute" => {
            ...
            println!("DID {} mentioned {}", r.did, r.mentioned_did);
        ...
        "prove" => {
            ...
            println!("Proof generated. DID {} mentioned {}", r.did, r.mentioned_did);
