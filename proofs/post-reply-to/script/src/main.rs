...
const ELF: Elf = include_elf!("post-reply-to-program");

#[derive(Parser)]
#[command(name = "post-reply-to", about = "Prove that a DID replied to a specific post")]
struct Args {
...
fn main() -> Result<()> {
    ...
    match args.mode.as_str() {
        "execute" => {
            ...
            println!("DID {} replied to {}", r.did, r.parent_uri);
        ...
        "prove" => {
            ...
            println!("Proof generated. DID {} replied to {}", r.did, r.parent_uri);
